...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'DashCliente',
          path: '/dashCliente',
          builder: (context, params) => DashClienteWidget(),
        ),
        FFRoute(
          name: 'MiCuenta',
          path: '/miCuenta',
        ...
        FFRoute(
          name: 'Cobranzas',
          path: '/cobranzas',
          builder: (context, params) => CobranzasWidget(),
        ),
        FFRoute(
          name: 'NuevaOS',
          path: '/nuevaOS',
          builder: (context, params) => NuevaOSWidget(),
        ),
        FFRoute(
          name: 'Compras',
          path: '/compras',
        ...
        FFRoute(
          name: 'MiCuentaAdmin',
          path: '/miCuentaAdmin',
          builder: (context, params) => MiCuentaAdminWidget(),
        ),
        FFRoute(
          name: 'NuevaOSadmin',
          path: '/nuevaOSadmin',
          builder: (context, params) => NuevaOSadminWidget(),
        ),
        FFRoute(
          name: 'ClientesProveedores',
          path: '/clientesProveedores',
          builder: (context, params) => ClientesProveedoresWidget(),
        ),
        FFRoute(
          name: 'VentasAdmin',
          path: '/ventasAdmin',
          builder: (context, params) => VentasAdminWidget(),
        )
